...
class SerialToolUI(object):
    ...
    def create_frm_left(self):
        ...
        Button按钮点击连接设备
        '''
        #先划好场子。告诉TK我有这么四个人，分别是A,B,C,D，
        self.frm_left_show_pic = pytk.PyLabelFrame(self.frm_left)
        ...
        self.frm_left_btn = pytk.PyButton(self.frm_left,
                                          ...
                                          command=self.Toggle)
        #然后排好座位。给他们四个分配好座位
        self.frm_left_show_pic.grid(row=0, column=0, padx=5, pady=5, sticky="wesn")
        ...
        self.create_frm_left_serial_show_pic()
        self.create_frm_left_serial_set()

    def create_frm_left_serial_show_pic(self):
        self.frm_left_label = pytk.PyLabel(self.frm_left_show_pic,text="Serial Ports",font=font)
        self.frm_left_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")
        self.frm_left_show_pic_btn = pytk.PyButton(self.frm_left_show_pic,
                                                text="Show",
                                                width=10,
                                                font=font,
                                                command=self.Show_Pic)
        self.frm_left_show_pic_btn.grid(row=0, column=1, padx=5, pady=5, sticky="e")
    ...
    def create_frm_right(self):
        ...
        #这才是布局的代码部分
        self.frm_right_receive.grid(row=0, column=0, padx=1, sticky="wesn")
        self.frm_right_clear.grid(row=1, column=0, padx=1, sticky="wesn")
        self.frm_right_send.grid(row=2, column=0, padx=1, sticky="wesn")
        self.frm_right_reset.grid(row=3, column=0, padx=1, sticky="wesn")
